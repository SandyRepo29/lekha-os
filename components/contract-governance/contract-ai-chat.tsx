  ...
  return (
    <Card className="p-6">
      ...
      <div className="rounded-xl bg-white border border-[var(--color-line)] p-4 h-72 overflow-y-auto space-y-4 mb-4">
        ...
        {loading && (
          <div className="flex justify-start">
            <div className="bg-[#F8F9FB] rounded-xl px-4 py-2.5">
      ...
      <div className="flex gap-2">
        <input
          className="flex-1 rounded-xl bg-[#F8F9FB] border border-[var(--color-line)] px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500/50 placeholder:text-[var(--color-ink-dim)]"
