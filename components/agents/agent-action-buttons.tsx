  ...
  return (
    <div className="flex shrink-0 items-center gap-2">
      ...
      <button
        onClick={reject}
        disabled={pending}
        className="flex items-center gap-1.5 rounded-xl bg-[#F8F9FB] border border-[var(--color-line)] px-3 py-1.5 text-xs font-medium text-[var(--color-ink-dim)] hover:bg-red-500/10 hover:text-red-400 hover:border-red-500/20 transition-colors disabled:opacity-50"
      >
