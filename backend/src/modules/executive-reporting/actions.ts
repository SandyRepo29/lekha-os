...
import * as svc from "@/backend/src/modules/executive-reporting/executive-reporting-service";
import * as ai from "@/backend/src/modules/executive-reporting/ai-executive-reporting-service";
