...
import * as svc from "@/backend/src/modules/control-center/control-center-service";
import * as aiSvc from "@/backend/src/modules/control-center/ai-control-service";
