...
} from "@/backend/src/modules/trust-intelligence/trust-intelligence-service";
import {
  generateExecutiveSummary,
  getCachedSummary,
  chat,
} from "@/backend/src/modules/trust-intelligence/ai-trust-intelligence-service";
...
import {
  ...
  generateForecast,
  chatTrends,
} from "@/backend/src/modules/trust-intelligence/ai-trends-service";
import {
  findAlerts,
  countAlerts,
  resolveAlert,
} from "@/backend/src/modules/trust-intelligence/governance-alerts-repo";
