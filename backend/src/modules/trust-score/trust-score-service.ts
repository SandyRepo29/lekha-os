...
import { computeContractHealth } from "@/backend/src/modules/contract-governance/contract-health";
...
import * as assessmentRepo from "@/backend/src/modules/vendor-hub/assessment-repo";
import * as reviewRepo from "@/backend/src/modules/vendor-hub/review-repo";
import * as requestRepo from "@/backend/src/modules/vendor-hub/request-repo";
import * as trustRepo from "@/backend/src/modules/trust-score/trust-score-repo";
...
export { getOrgTrustMetrics } from "@/backend/src/modules/trust-score/trust-score-repo";
