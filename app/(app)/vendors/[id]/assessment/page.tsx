...
import { startAssessment, submitAssessment } from "@/backend/src/modules/vendor-hub/assessments-actions";
import { listAssessments, getAssessment } from "@/backend/src/modules/vendor-hub/assessment-service";
...
export default async function AssessmentPage({
  ...
  return (
    <div className="mx-auto max-w-3xl space-y-6">
      ...
      <div>
        <h1 className="font-[family-name:var(--font-display)] text-xl font-bold">Security Assessment</h1>
