...
export default async function ControlAiPage() {
  ...
  if (session.demo || !session.org) {
    return (
      <Card className="p-6">
        <p className="text-sm text-[var(--color-ink-dim)]">Connect Supabase to use the AI Control Advisor.</p>
      </Card>
    );
  }
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-[var(--color-ink-dim)] mt-0.5">
          AI-powered analysis of your control library and health posture
        </p>
      </div>
