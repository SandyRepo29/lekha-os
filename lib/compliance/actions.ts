...
import * as frameworkService from "@/lib/services/compliance/framework-service";
import { FRAMEWORK_TEMPLATE_MAP } from "@/lib/constants/compliance-framework-templates";
import * as controlService from "@/lib/services/compliance/control-service";
import * as evidenceService from "@/lib/services/compliance/evidence-service";
import * as policyService from "@/lib/services/compliance/policy-service";
import * as gapService from "@/lib/services/compliance/gap-service";
import * as aiService from "@/lib/services/compliance/ai-compliance-service";
