...
import * as contactRepo from "@/lib/repositories/vendor-contacts-repo";
import * as timelineRepo from "@/lib/repositories/vendor-timeline-repo";
import type { ContactType, VendorContact } from "@/lib/repositories/vendor-contacts-repo";

export type { ContactType, VendorContact };
export { CONTACT_TYPE_LABELS } from "@/lib/repositories/vendor-contacts-repo";
