...
import {
  ...
  insertRecentSearch,
  findRecentSearches,
} from "@/lib/repositories/platform/search-repo";

export type { SearchResult } from "@/lib/repositories/platform/search-repo";
import type { SearchResult, SavedSearch } from "@/lib/repositories/platform/search-repo";
